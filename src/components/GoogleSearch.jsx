...
const GoogleSearch = () => {
  const [feelingText, setFeelingText] = useState("I'm Feeling Lucky");

  const handleFeelingHover = () => {
    let newPhrase;
    do {
      newPhrase = FEELING_PHRASES[Math.floor(Math.random() * FEELING_PHRASES.length)];
    } while (newPhrase === feelingText);
    setFeelingText(newPhrase);
  };

  const handleFeelingLeave = () => {
    setFeelingText("I'm Feeling Lucky");
  };
      ...
      <div className="search-wrapper">
        ...
        <div className="search-buttons">
          ...
          <input
            ...
            name="btnI"
            tabIndex="0"
            onMouseEnter={handleFeelingHover}
            onMouseLeave={handleFeelingLeave}
          />
        </div>

        <div className="language-options">
          Google offered in: <a href="#">Deutsch</a>
        </div>
      </div>
    </div>
  );
